...
interface ProjectModalProps {
  project: Project;
  onClose: () => void;
  labels: { close: string; viewApp: string };
}
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
      ...
      >
        ...
        <div className="h-48 md:h-64 w-full relative shrink-0">
            <img 
                src={`https://picsum.photos/seed/${project.imageSeeds[0]}/1200/600`} 
                alt={project.title} 
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-10">
            <div className="flex flex-col md:flex-row gap-8 justify-between items-start mb-8">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        <span className="text-blue-400 font-mono text-xs uppercase tracking-widest">{project.type} Project</span>
                ...
                <a 
                    href="#" // In a real app, this would be project.url
            ...
            <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-10">
                ...
                <div className="space-y-8">
                     <div>
                        <h3 className="text-lg font-semibold text-white mb-4">Stack</h3>
                    ...
                    {project.challenges && (
                        <div>
                            <h3 className="text-lg font-semibold text-white mb-4">Technical Challenges</h3>
