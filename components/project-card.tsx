...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, viewAppLabel, projectTypeLabel, onOpenModal }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-zinc-400 font-mono text-xs uppercase tracking-widest">{projectTypeLabel}</span>
          </div>

          <div className="space-y-2">
            <h3 className="text-3xl md:text-5xl font-bold tracking-tighter text-white leading-[0.95]">
              {project.title}
            </h3>
      ...
      <motion.div
        ...
        className="w-full flex-1 flex justify-center items-center relative mt-2 min-h-0"
      >
        <div className={`relative ${isMobile ? 'h-full max-h-[60vh] w-auto aspect-[9/17]' : 'w-full md:w-[90%] max-h-[60vh] aspect-[16/10]'}`}>
