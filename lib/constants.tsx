      ...
      items: [
        {
          ...
          type: "mobile",
          images: [
            "/projects/budget/dashboard.jpg",
            "/projects/budget/dashboard2.jpg",
            "/projects/budget/chat1.jpg",
            "/projects/budget/chat2.jpg",
            "/projects/budget/chat3.jpg"
          ],
        ...
        },
        {
          ...
          url: "https://picopi.io",
          images: [
            "/projects/picopi/landing.png",
            "/projects/picopi/redesign.png",
            "/projects/picopi/audit.png",
            "/projects/picopi/projectdetails.png",
            "/projects/picopi/createprojetct.png",
            "/projects/picopi/projects.png",
            "/projects/picopi/split1.png",
            "/projects/picopi/split2.png"
          ],
        ...
        },
        {
          ...
          images: [
            "/projects/uxtools/hub.png",
            "/projects/uxtools/tool1-1.png",
            "/projects/uxtools/tool1-2.png"
          ],
        ...
        },
        {
          ...
          images: [
            "/projects/aol/landing.png",
            "/projects/aol/dashboard.png",
            "/projects/aol/creationhub.png",
            "/projects/aol/createlook.png",
            "/projects/aol/createpuppet.png",
            "/projects/aol/details.png",
            "/projects/aol/gallery.png",
            "/projects/aol/garments.png",
            "/projects/aol/models.png"
          ],
      ...
      items: [
        {
          ...
          location: "Québec",
          details: [
            "Analyse et refonte de modules critiques pour la Médecine (gestion des stages, appréciation), supportant plus de 70 gestionnaires.",
            "Maintenance de 50+ applications et intervention d'urgence sur les dossiers étudiants lors de périodes de crise.",
            "Optimisation des processus TI : Refonte JIRA (Kanban/Actifs) et contribution à la modernisation du Design System."
          ]
        },
        {
          ...
          location: "Québec",
          details: [
            "Backend (Rémunération) : Développement d'APIs REST .NET critiques pour le paiement des courtiers.",
            "Frontend (Marketing) : Refonte complète de la page 'Trouver un formulaire' (toujours en production) et maintenance des sites publics.",
            "Migration automatisée de bases de données et gestion des pipelines CI/CD Azure DevOps."
          ]
        }
      ]
    },
      ...
      items: [
        {
          ...
          location: "Quebec",
          details: [
            "Analysis and redesign of critical modules for Medicine (internships, assessments), supporting over 70 managers.",
            "Maintenance of 50+ applications and emergency intervention on student records during crisis periods.",
            "IT Process Optimization: Jira overhaul (Kanban/Assets) and contribution to Design System modernization."
          ]
        },
        {
          ...
          location: "Quebec",
          details: [
            "Backend (Remuneration): Development of critical .NET REST APIs for broker payment systems.",
            "Frontend (Marketing): Complete redesign of the 'Find a form' page (live in production) and public site maintenance.",
            "Automated database migration and Azure DevOps CI/CD pipeline management."
          ]
        }
      ]
    },
